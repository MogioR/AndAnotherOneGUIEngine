...
void Button::setTextString(std::string text)
{
...
Button::Button(std::string text, Font &font, FloatRect rect, std::string onClick, std::string onCover) :
	text(text, font), Gui(rect, true, onClick, onCover, true) {}

void Button::correctSizeText()
{
